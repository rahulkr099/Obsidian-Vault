Great example 👍  
Drag and Drop is a **very important UI concept**, and your code is clean and minimal.  
Below is **simple, exam-friendly pseudocode** that explains **how drag and drop works step by step**.
...
• Browser temporarily stores its identity  
• Drop area allows the drop  
• Element is moved into drop area
...
- Restrict drop to certain areas
...
- Upgrade this drag-drop fully
    
- Draw a **flowchart**
    
- Explain **DataTransfer visually**
    
- Convert into **React drag & drop**
...
You’re ready for advanced stuff now:

- Drag between **multiple drop zones**
    
- Sortable lists (like Trello)
    
- Animate drop transitions
...
If you say **“add sortable list”** or **“React version”**, I’ll do it next 🔥